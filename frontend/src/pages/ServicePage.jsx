...
const ServicesPage = () => {
    return (
        <div className="flex flex-col min-h-screen">
            <Header />
            <main className="lg:text-2xl flex-grow text-gray-600 font-light leading-relaxed space-y-6
                ...
                <div className="py-24 bg-white">
                    <div className="max-w-screen-2xl mx-auto px-4 space-y-20">
                        <ServiceDetailCard
                            ...
                            image="../../../images/services/handwork.jpg" // Замените фото
                        />
                        <ServiceDetailCard
                            ...
                            image="../../../images/services/prepare.jpg" // Замените фото
                            reverse={true}
                        />
                        <ServiceDetailCard
                            ...
                            image="../../../images/services/credit.jpg" // Замените фото
                        />
                    </div>
                </div>
            </main>
